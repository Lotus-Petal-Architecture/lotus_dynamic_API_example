...
function frame1()
{
    document.getElementById("info").innerHTML = '<h1>Large Cap = <span style="color:#ffca85;">Inner Ring</span></h1>';
    document.getElementById("intro").innerHTML = '<img src="files/intro/Slide1.png" style="max-width:99%; text-align:center;">';
}

function frame2()
{
    document.getElementById("info").innerHTML = '<h1>Mid Cap = <span style="color:#ffca85;">Middle Ring</span></h1>';
    document.getElementById("intro").innerHTML = '<img src="files/intro/Slide2.png" style="max-width:99%; text-align:center;">';
 
}

function frame3()
{
    document.getElementById("info").innerHTML = '<h1>Small Cap = <span style="color:#ffca85;">Outer Ring</span></h1>';
    document.getElementById("intro").innerHTML = '<img src="files/intro/Slide3.png" style="max-width:99%;text-align:center;">';    
}
...
function getData() //processes JSON data and returns arrays for 5 main variables
  ...
  document.getElementById("intro").innerHTML = '<img src="files/intro/Slide0.png" style="max-width:50%; text-align:center;">'; 
